...
async function loadFacts() {
  const res = await fetch(
    "https://ianhvyvsuohmcxlpqdkc.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imlhbmh2eXZzdW9obWN4bHBxZGtjIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzY0ODEzOTcsImV4cCI6MTk5MjA1NzM5N30._O1LFr5capziDeyZPD2N0IM9kSdjGokHbwtcaUq1eLc",
      },
    }
  );
...
const [text, createdIn, inCorrect] = fact;
